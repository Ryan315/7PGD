# image root
test_index_path = 'dataset/release_v0/release_v0/meta/test_indexes.csv'
train_index_path = 'dataset/release_v0/release_v0/meta/train_indexes_my.csv'
# val_index_path = 'dataset/release_v0/release_v0/meta/valid_indexes.csv'
val_index_path = 'dataset/release_v0/release_v0/meta/test_indexes.csv'
img_info_path = 'dataset/release_v0/release_v0/meta/meta_organized_small_atypical.csv'
source_dir = 'dataset/release_v0/release_v0/images/'
